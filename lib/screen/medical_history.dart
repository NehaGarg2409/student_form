      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Medical Condition of Student", style: TextStyle(fontSize: 10)),
            Row(
              children: [
                Radio<bool>(
                  value: true,
                ...
                const Text("Good", style: TextStyle(fontSize: 10)),
                ...
                const Text("Bad", style: TextStyle(fontSize: 10)),
              ],
            ),
            const SizedBox(height: 12),
            _textField("Allergies", allergiesController),
            const SizedBox(height: 24),
            _textField("Medication", medicationController),
            const SizedBox(height: 12),
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    print("Condition: ${medicalCondition == true ? "Good" : "Bad"}");
