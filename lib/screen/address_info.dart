      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _textField("Current Address", currentAddressController),
            const SizedBox(height: 30),
            _textField("Permanent Address", permanentAddressController),
            const SizedBox(height: 12),
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // You can access text values here if needed
                    print("Current: ${currentAddressController.text}");
                    print("Permanent: ${permanentAddressController.text}");
                    provider.nextStep();
                  },
                  style: ElevatedButton.styleFrom(
